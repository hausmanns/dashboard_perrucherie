"""Plant identification via a vision LLM through OpenRouter.

Sends a photo to a multimodal model (default: google/gemini-2.5-flash) and
asks for strict JSON describing the plant, which is used to pre-fill the
"new plant" form.
"""
...
PROMPT = """Tu es un expert en botanique et en plantes d'intérieur.
...
class IdentificationError(Exception):
    """Raised when the model could not identify a plant."""
